  ...
  <div class="app-container">
    <div v-show="isShow">
      <div class="input">
        ...
        <!-- 搜索框加按钮 -->
        <el-input v-model="searchData" placeholder="请搜索关键词" prefix-icon="el-icon-search" style="width:200px;" />
  ...
  methods: {
    ...
    remove(index, row) {
      this.$http.delete('/position/' + row.positionId).then(result => {
        this.$confirm(`确定删除【${row.positionName}】职位吗?`, '提示', {
