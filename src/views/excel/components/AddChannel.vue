<template>
  <div v-show="isShow" class="staff">
    <div class="title">
      <span class="export">添加渠道</span>
      <span class="right">
        <a href="#" @click="goback">渠道列表</a> /<a href="#">添加渠道</a>
      </span>
    ...
    gohome() {
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          this.$http.post('/channel', this.$qs.stringify(this.form)).then(result => {
            console.log(result)
